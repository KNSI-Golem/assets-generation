...
def compute_score_raw(batchSize,
    ...
    feature_r = convnet_feature_saver.save(true_folder)
    feature_f = convnet_feature_saver.save(fake_folder)
...
if __name__ == '__main__':
    score = compute_score_raw(32, 'fake_images', 'real_images')
    incepcion_score = score[28]
    mode_score = score[29]
    fid = score[30]