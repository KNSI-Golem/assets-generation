...
if __name__ == '__main__':    
    ...
    mask1 = df['Background_percentage'] < 0.65
    mask2 = df['Background_percentage'] > 0.40
    ...
    # train model
    gan.train(g_model, d_model, gan_model, training_data, latent_dim, gan_results, n_epochs=2000)
